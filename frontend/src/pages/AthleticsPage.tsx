...
const SCHEDULE = [
  {
    day: '第一天｜6月6日（六）',
    events: [
      { time: '14:25', name: '女子 撐竿跳高(PV) — 決賽', tag: '跳躍' },
      { time: '14:30', name: '女子 100mH(0.838m) — 預賽', tag: '跨欄' },
      { time: '14:45', name: '男子 鐵餅(DT)(2kg) — 決賽', tag: '投擲' },
      { time: '14:50', name: '男子 110mH(1.067m) — 預賽', tag: '跨欄' },
      { time: '15:15', name: '女子 400m — 預賽', tag: '短跑' },
      { time: '15:30', name: '男子 三級跳遠(TJ) — 決賽', tag: '跳躍' },
      { time: '15:35', name: '男子 400m — 預賽', tag: '短跑' },
      { time: '16:00', name: '女子 100m — 預賽', tag: '短跑' },
      { time: '16:20', name: '男子 100m — 預賽', tag: '短跑' },
      { time: '16:40', name: '女子 1500m — 決賽', tag: '中距離' },
      { time: '16:55', name: '男子 1500m — 計時決賽', tag: '中距離' },
      { time: '17:15', name: '女子 鏈球(HT)(4kg) — 決賽', tag: '投擲' },
      { time: '17:45', name: '男子 撐竿跳高(PV) — 決賽', tag: '跳躍' },
      { time: '18:00', name: '女子 100mH(0.838m) — 決賽', tag: '跨欄' },
      { time: '18:15', name: '男子 110mH(1.067m) — 決賽', tag: '跨欄' },
      { time: '18:20', name: '男子 鉛球(SP)(7.26kg) — 決賽', tag: '投擲' },
      { time: '18:30', name: '女子 跳遠(LJ) — 決賽', tag: '跳躍' },
      { time: '18:30', name: '女子 400m — 決賽', tag: '短跑' },
      { time: '18:40', name: '男子 400m — 決賽', tag: '短跑' },
      { time: '18:55', name: '女子 100m — 決賽', tag: '短跑' },
      { time: '19:05', name: '男子 100m — 決賽', tag: '短跑' },
      { time: '19:20', name: '男子 3000m 障礙(0.914m) — 決賽', tag: '中距離' },
      { time: '19:45', name: '男子 鏈球(HT)(7.26kg) — 決賽', tag: '投擲' },
      { time: '19:45', name: '女子 3000m 障礙(0.762m) — 決賽', tag: '中距離' },
      { time: '20:10', name: '女子 4x100m 接力 — 計時決賽', tag: '接力' },
      { time: '20:25', name: '男子 4x100m 接力 — 計時決賽', tag: '接力' },
      { time: '20:45', name: '混合 4x400m 接力 — 決賽', tag: '接力' },
    ],
  },
  {
    day: '第二天｜6月7日（日）',
    events: [
      { time: '14:25', name: '女子 三級跳遠(TJ) — 決賽', tag: '跳躍' },
      { time: '14:30', name: '女子 400mH(0.762m) — 預賽', tag: '跨欄' },
      { time: '14:35', name: '女子 標槍(JT)(600g) — 決賽', tag: '投擲' },
      { time: '14:50', name: '男子 400mH(0.914m) — 預賽', tag: '跨欄' },
      { time: '15:00', name: '女子 跳高(HJ) — 決賽', tag: '跳躍' },
      { time: '15:20', name: '男子 800m — 預賽', tag: '中距離' },
      { time: '15:55', name: '女子 200m — 預賽', tag: '短跑' },
      { time: '16:30', name: '男子 200m — 預賽', tag: '短跑' },
      { time: '16:40', name: '男子 標槍(JT)(800g) — 決賽', tag: '投擲' },
      { time: '17:10', name: '男子 跳遠(LJ) — 決賽', tag: '跳躍' },
      { time: '17:50', name: '女子 400mH(0.762m) — 決賽', tag: '跨欄' },
      { time: '18:00', name: '女子 跳高(HJ) — 決賽', tag: '跳躍' },
      { time: '18:00', name: '男子 400mH(0.914m) — 決賽', tag: '跨欄' },
      { time: '18:15', name: '女子 800m — 計時決賽', tag: '中距離' },
      { time: '18:25', name: '男子 800m — 決賽', tag: '中距離' },
      { time: '18:40', name: '女子 200m — 決賽', tag: '短跑' },
      { time: '18:45', name: '女子 鐵餅(DT)(1kg) — 決賽', tag: '投擲' },
      { time: '18:50', name: '男子 200m — 決賽', tag: '短跑' },
      { time: '19:00', name: '女子 鉛球(SP)(4kg) — 決賽', tag: '投擲' },
      { time: '19:05', name: '女子 5000m — 決賽', tag: '中距離' },
      { time: '19:35', name: '男子 5000m — 決賽', tag: '中距離' },
      { time: '20:05', name: '女子 4x400m 接力 — 決賽', tag: '接力' },
      { time: '20:15', name: '男子 4x400m 接力 — 決賽', tag: '接力' },
    ],
  },
];
